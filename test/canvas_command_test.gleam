...
import saola/component/canvas.{
  ...
  Stroke, Translate, encode_commands, hit_test,
}
...
pub fn hit_test_rect_inside_test() {
  ...
  assert hit_test(areas, 60.0, 35.0) == Some("hit")
}

pub fn hit_test_rect_top_left_corner_test() {
  let areas = [RectHit(10.0, 10.0, 100.0, 50.0, "hit")]
  assert hit_test(areas, 10.0, 10.0) == Some("hit")
}

pub fn hit_test_rect_bottom_right_corner_test() {
  let areas = [RectHit(10.0, 10.0, 100.0, 50.0, "hit")]
  assert hit_test(areas, 110.0, 60.0) == Some("hit")
}

pub fn hit_test_rect_outside_x_test() {
  let areas = [RectHit(10.0, 10.0, 100.0, 50.0, "hit")]
  assert hit_test(areas, 111.0, 35.0) == None
}

pub fn hit_test_rect_outside_y_test() {
  let areas = [RectHit(10.0, 10.0, 100.0, 50.0, "hit")]
  assert hit_test(areas, 60.0, 61.0) == None
}
...
pub fn hit_test_empty_areas_test() {
  assert hit_test([], 50.0, 50.0) == None
}
...
pub fn hit_test_returns_first_match_test() {
  ...
  assert hit_test(areas, 50.0, 50.0) == Some("back")
}
...
pub fn hit_test_no_match_multiple_areas_test() {
  ...
  assert hit_test(areas, 150.0, 150.0) == None
}
